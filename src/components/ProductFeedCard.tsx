...
const ProductFeedCard: React.FC<ProductFeedCardProps> = ({
  ...
  // Featured card - extra tall with emphasis
  if (variant === 'featured') {
      ...
      >
        ...
        <View style={[styles.bottomInfo, styles.featuredInfo]}>
          <View style={styles.productInfo}>
            ...
            <Text style={[styles.itemName, styles.featuredName]} numberOfLines={3}>
              {product.item_name}
            </Text>
            <View style={styles.tags}>
  ...
  // Compact card - shorter for variety
  if (variant === 'compact') {
        ...
        <View style={styles.compactContent}>
          <View style={styles.compactTop}>
            <Pressable
              ...
              onPress={handleSubscribeToggle}
            >
              <Text style={[styles.storeText, styles.compactStoreText]}>
                {product.store}
              </Text>
              <Ionicons
                name={isSubscribed ? 'checkmark-circle' : 'add-circle-outline'}
          ...
          <View style={styles.compactBottom}>
            ...
            <Text style={[styles.itemName, styles.compactName]} numberOfLines={2}>
              {product.item_name}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.wideLayout}>
          ...
          <View style={styles.wideContent}>
            ...
            <View style={styles.wideInfo}>
              ...
              <Text style={[styles.itemName, styles.wideName]} numberOfLines={3}>
                {product.item_name}
              </Text>
              <View style={styles.tags}>
                {product.tags.slice(0, 3).map((tag, index) => (
